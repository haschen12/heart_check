...
results.append("низкая. Срочно обратитесь к врачу!")
results.append("удовлетворительная. Обратитесь к врачу!")
results.append("средняя. Возможно, стоит дополнительно обследоваться у врача.")
results.append("выше среднего")
results.append("высокая")